...
def blast_and_plot(PHAGES_input,file_name,path):
    ...
    CRISPR_path = home_directory + '/CRISPRresult.txt'
      
    result = pd.read_csv(CRISPR_path, sep ='\t', names=names)
...
for subdir, dirs, files in os.walk(CRISPR_folder_path):
    ...
    folder_path = str(subdir) + folder_name  #in the same folder
...
print('Finish, all phages was detected')
print('')

print('you can find your result in ' + folder_name + ' folder')
